...
namespace Cdy.Tag
{
    ...
    /// 
    /// </summary>
    public class MarshalVarintCodeMemory:IDisposable
    {

        #region ... Variables  ...
        private IntPtr mDataBuffer;
        ...
        /// 
        /// </summary>
        public MarshalVarintCodeMemory(int size)
        {
            mDataBuffer = Marshal.AllocHGlobal(size);
            position = 0;
            limit = size;
        }
        ...
        public void WriteInt32(uint value)
        {
            ...
            {
                Marshal.WriteByte(mDataBuffer + position++, (byte)((value & 0x7F) | 0x80));
            ...
            if (position < limit)
            {
                Marshal.WriteByte(mDataBuffer + position++, (byte)value);
        ...
        public uint ReadRawVarint32()
        {
            ...
            int tmp = Marshal.ReadByte(mDataBuffer + position++);
            if (tmp < 128)
            {
                return (uint)tmp;
            }
            ...
            int result = tmp & 0x7f;
            if ((tmp = Marshal.ReadByte(mDataBuffer + position++)) < 128)
            {
                result |= tmp << 7;
            }
            else
            {
                ...
                else
                {
                    ...
                    {
                        result |= (tmp & 0x7f) << 21;
                        result |= (tmp = Marshal.ReadByte(mDataBuffer + position++)) << 28;
                        if (tmp >= 128)
                        {
        ...
        {
            return Marshal.ReadByte(mDataBuffer + position++);
        }
    ...
    /// 
    /// </summary>
    public static class MarshalVarintCodeMemoryExtends
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public static List<int> ToIntList(this MarshalVarintCodeMemory memory)
        {
        ...
        /// <param name="memory"></param>
        /// <returns></returns>
        public static List<long> ToLongList(this MarshalVarintCodeMemory memory)
        {
