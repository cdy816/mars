...
namespace Cdy.Tag
{
    ...
    public class HisDatabaseSerise
    {
        ...
        /// <returns></returns>
        public HisDatabase LoadDifferenceByName(string name, Func<HisTag,bool> compareaction)
        {
            return LoadDifference(PathHelper.helper.GetDataPath(name, name + ".hdb"), compareaction);
        }
        ...
        /// <param name="compareaction"></param>
        /// <returns></returns>
        public HisDatabase LoadDifference(string file,Func<HisTag,bool> compareaction)
        {
            HisDatabase db = new HisDatabase();
            if (System.IO.File.Exists(file))
            {
