...
namespace DBInStudio.Desktop.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 An object template is an abstraction of a group of variables with relevance. Through the object template, you can quickly create and maintain a group of related variables in batches; By maintaining object templates, you can automatically synchronize to variables generated by this class. 的本地化字符串。
        /// </summary>
        ...
        ///   查找类似 Invert 的本地化字符串。
        /// </summary>
        internal static string InvertConvert {
            get {
                return ResourceManager.GetString("InvertConvert", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 Invert bool 的本地化字符串。
        /// </summary>
        internal static string InvertConvertTitle {
            get {
                return ResourceManager.GetString("InvertConvertTitle", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Search not used id from special value to set to tag 的本地化字符串。
        /// </summary>
        internal static string ResetTagIdLable {
            get {
                return ResourceManager.GetString("ResetTagIdLable", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string SetFailed {
            get {
                return ResourceManager.GetString("SetFailed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Set  special value to tag id 的本地化字符串。
        /// </summary>
        internal static string SetTagIdLable {
            get {
                return ResourceManager.GetString("SetTagIdLable", resourceCulture);
            }
        }
