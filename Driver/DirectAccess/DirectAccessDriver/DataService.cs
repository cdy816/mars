...
namespace DirectAccessDriver
{
    ...
    public class DataService: SocketServer2
    {
        ...
        /// 
        /// </summary>
        public override string Name => "DirectAccessDriverDataService";
        ...
        private ByteBuffer TagInfoRequest(string clientId, ByteBuffer memory)
        {
            ...
            {
                LoggerService.Service.Info("DirectAccessDriver", "DirectAccessDriver driver is not started!");
            }
            return null;
        }
        ...
        public override void Start(int port)
        {
            ...
            {
                LoggerService.Service.Erro("DirectAccessDriver", ex.Message);
            }
            base.Start(port);
        }
