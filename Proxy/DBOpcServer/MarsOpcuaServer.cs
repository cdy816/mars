...
namespace DBOpcServer
{
    ...
    /// Mars 数据库OPC服务
    /// </summary>
    internal class MarsOpcuaServer : StandardServer
    {
        ...
        protected override MasterNodeManager CreateMasterNodeManager(IServerInternal server, ApplicationConfiguration configuration)
        {
            ...
            nodeManagers.Add(new MarsNodeManager(server, configuration));
        ...
        protected override ServerProperties LoadServerProperties()
        {
            ...
            properties.ProductName = "Mars Opc Server";
            properties.ProductUri = "http://cdyfoundationorg/Mars";
        ...
        private IUserIdentity VerifyPassword(UserNameIdentityToken userNameToken)
        {
            ...
            var mm = Cdy.Tag.ServiceLocator.Locator.Resolve<IRuntimeSecurity>();
            if(mm.LoginOnce(userName, password))
            {
                var vtmps = mm.GetPermission(userName).Select(e => e.SuperPermission);
                if (vtmps.Any() && vtmps.Contains(true))
                {
