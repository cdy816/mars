    ...
    internal class OPCServer
    {
        ...
        public void Start()
        {
            try
            {
                ...
                {
                    ApplicationName = "marsopcua",
                    ApplicationUri = Utils.Format(@"urn:{0}:marsopcua", System.Net.Dns.GetHostName()),
                    ...
                    {
                        ApplicationCertificate = new CertificateIdentifier { StoreType = "X509Store", StorePath = @"CurrentUser\Mars", SubjectName = Utils.Format(@"CN={0},S=beijing,E=cdy816@hotmail.com,C=CN,O=cdy, DC={1}", "MarsOpcua", System.Net.Dns.GetHostName()) },
                ...
                // start the server.
                application.Start(new MarsOpcuaServer()).Wait();
