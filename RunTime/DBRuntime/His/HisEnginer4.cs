...
namespace Cdy.Tag
{
    ...
    /// 历史数据引擎4
    /// </summary>
    public class HisEnginer4 : IHisEngine3, ITagHisValueProduct, IDisposable, IHisTagQuery
    {
        ...
        public HisEnginer4(Cdy.Tag.HisDatabase manager, Cdy.Tag.RealEnginer realEnginer)
        {
            mManager = manager;
