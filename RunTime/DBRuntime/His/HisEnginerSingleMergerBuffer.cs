...
namespace Cdy.Tag
{
    ...
    /// 历史数据引擎
    /// </summary>
    public class HisEnginerSingleMergerBuffer : IHisEngine
    {
        ...
        /// 
        /// </summary>
        public HisEnginerSingleMergerBuffer()
        {
        ...
        public HisEnginerSingleMergerBuffer(Cdy.Tag.HisDatabase manager, Cdy.Tag.RealEnginer realEnginer)
        {
            mManager = manager;
